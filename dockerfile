...
#To run an example:
#TAG INSTANCE: docker run -i -t my-cypress-image:1.1.0 cypress run --spec cypress/e2e/features/* --env tags=@mobile
#CHROME INSTANCE: docker run -i -t my-cypress-image:1.1.0 cypress run --spec cypress/e2e/features/* --browser chrome
#FIREFOX INSTANCE: docker run -i -t my-cypress-image:1.1.0 cypress run --spec cypress/e2e/features/* --browser firefox
